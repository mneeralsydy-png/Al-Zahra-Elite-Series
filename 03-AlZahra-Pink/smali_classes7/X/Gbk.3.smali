...
.method public constructor <init>(LX/095;)V
    ...
    iput-object p1, p0, LX/Gbk;->A00:LX/095;

    new-instance v0, LX/EXU;

    invoke-direct {v0}, LX/EXU;-><init>()V

    iput-object v0, p0, LX/Gbk;->A01:LX/EXU;
...
# virtual methods
.method public AOR(Ljava/util/List;LX/092;)Ljava/lang/Object;
    .locals 5

    iget-object v1, p0, LX/Gbk;->A01:LX/EXU;
    ...
    iget-object v0, v1, LX/FD1;->A00:Ljava/lang/ref/SoftReference;
    ...
    invoke-virtual {v1, v0}, LX/FD1;->A00(LX/00h;)Ljava/lang/Object;
    ...
    check-cast v1, LX/H22;

    new-instance v0, LX/GZd;

    invoke-direct {v0, v1}, LX/GZd;-><init>(LX/H22;)V
    ...
    :cond_1
    iget-object v2, v4, LX/F1O;->A00:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :try_start_0
    iget-object v0, p0, LX/Gbk;->A00:LX/095;
