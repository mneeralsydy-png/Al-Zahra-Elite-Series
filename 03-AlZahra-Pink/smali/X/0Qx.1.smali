...
.method private checkOnClickListener(Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v0, p1, v1}, LX/Chx;-><init>(Landroid/view/View;Ljava/lang/String;)V
...
.method public createAutoCompleteTextView(Landroid/content/Context;Landroid/util/AttributeSet;)LX/Amo;
    ...
    invoke-direct {v0, p1, p2}, LX/Amo;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public createCheckedTextView(Landroid/content/Context;Landroid/util/AttributeSet;)LX/Amy;
    .locals 1

    new-instance v0, LX/Amy;

    invoke-direct {v0, p1, p2}, LX/Amy;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public createMultiAutoCompleteTextView(Landroid/content/Context;Landroid/util/AttributeSet;)LX/Aou;
    .locals 1

    new-instance v0, LX/Aou;

    invoke-direct {v0, p1, p2}, LX/Aou;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public createRatingBar(Landroid/content/Context;Landroid/util/AttributeSet;)LX/Ap0;
    .locals 1

    new-instance v0, LX/Ap0;

    invoke-direct {v0, p1, p2}, LX/Ap0;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public createToggleButton(Landroid/content/Context;Landroid/util/AttributeSet;)LX/Ap7;
    .locals 1

    new-instance v0, LX/Ap7;

    invoke-direct {v0, p1, p2}, LX/Ap7;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method public final createView(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZZZ)Landroid/view/View;
    ...
    invoke-direct {v0, v1, p4}, LX/Ap0;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v0, v1, p4}, LX/Amy;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v0, v1, p4}, LX/Aou;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v0, v1, p4}, LX/Ap7;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-virtual {p0, v1, p4}, LX/0Qx;->createAutoCompleteTextView(Landroid/content/Context;Landroid/util/AttributeSet;)LX/Amo;
