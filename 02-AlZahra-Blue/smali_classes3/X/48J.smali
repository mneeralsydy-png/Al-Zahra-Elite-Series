...
.method public getEventNameForFalco()Ljava/lang/String;
    ...
    const-string v0, "wam_ai_creation_action"
...
.method public getFieldsMapForFalco()Ljava/util/Map;
    ...
    const-string v1, "ai_character_create_clicks"

    iget-object v0, p0, LX/48J;->A02:Ljava/lang/Long;

    invoke-interface {v2, v1, v0}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "ai_character_creation_completed"

    iget-object v0, p0, LX/48J;->A03:Ljava/lang/Long;

    invoke-interface {v2, v1, v0}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "ai_character_creation_initiated"

    iget-object v0, p0, LX/48J;->A04:Ljava/lang/Long;

    invoke-interface {v2, v1, v0}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "ai_character_deleted"

    iget-object v0, p0, LX/48J;->A05:Ljava/lang/Long;

    invoke-interface {v2, v1, v0}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    const-string v1, "ai_creation_published_public"
    ...
    const-string v1, "new_ai_creation_published_public"
...
.method public toString()Ljava/lang/String;
    ...
    const-string v0, "WamAiCreationAction {"

    invoke-virtual {v2, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string v1, "aiCharacterCreateClicks"

    iget-object v0, p0, LX/48J;->A02:Ljava/lang/Long;

    invoke-static {v0, v1, v2}, LX/0DC;->A00(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/StringBuilder;)V

    const-string v1, "aiCharacterCreationCompleted"

    iget-object v0, p0, LX/48J;->A03:Ljava/lang/Long;

    invoke-static {v0, v1, v2}, LX/0DC;->A00(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/StringBuilder;)V

    const-string v1, "aiCharacterCreationInitiated"

    iget-object v0, p0, LX/48J;->A04:Ljava/lang/Long;

    invoke-static {v0, v1, v2}, LX/0DC;->A00(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/StringBuilder;)V

    const-string v1, "aiCharacterDeleted"

    iget-object v0, p0, LX/48J;->A05:Ljava/lang/Long;

    invoke-static {v0, v1, v2}, LX/0DC;->A00(Ljava/lang/Object;Ljava/lang/String;Ljava/lang/StringBuilder;)V

    const-string v1, "aiCreationPublishedPublic"
    ...
    const-string v1, "newAiCreationPublishedPublic"
...
.method public validate()Ljava/util/List;
    ...
    const-string v3, "ai_creation_action"

    if-nez v0, :cond_9

    sget-object v1, LX/01d;->A00:LX/01d;

    const-string v0, "ai_character_create_clicks"
    ...
    const-string v0, "ai_character_creation_completed"
    ...
    const-string v0, "ai_character_creation_initiated"
    ...
    const-string v0, "ai_character_deleted"
    ...
    const-string v0, "ai_creation_published_public"
    ...
    const-string v0, "new_ai_creation_published_public"
