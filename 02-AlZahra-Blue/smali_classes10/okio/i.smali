...
.method constructor <init>(Lokio/Source;)V
    ...
    iput-object v0, p0, Lokio/i;->a:Lokio/Buffer;

    if-eqz p1, :cond_0

    iput-object p1, p0, Lokio/i;->b:Lokio/Source;
...
.method public final buffer()Lokio/Buffer;
    ...
    iget-object v0, p0, Lokio/i;->a:Lokio/Buffer;
...
.method public final close()V
    ...
    iget-boolean v0, p0, Lokio/i;->c:Z
    ...
    iget-object v0, p0, Lokio/i;->b:Lokio/Source;
...
.method public final exhausted()Z
    ...
    iget-object v1, p0, Lokio/i;->b:Lokio/Source;
...
.method public final indexOf(B)J
    ...
    invoke-virtual/range {v0 .. v5}, Lokio/i;->indexOf(BJJ)J
...
.method public final indexOf(BJJ)J
    ...
    iget-object v1, p0, Lokio/i;->a:Lokio/Buffer;
    ...
    iget-object v3, p0, Lokio/i;->b:Lokio/Source;
...
.method public final indexOf(Lokio/ByteString;)J
    ...
    invoke-virtual {p0, p1, v0, v1}, Lokio/i;->indexOf(Lokio/ByteString;J)J
...
.method public final indexOf(Lokio/ByteString;J)J
    ...
    iget-object v5, p0, Lokio/i;->b:Lokio/Source;
...
.method public final indexOfElement(Lokio/ByteString;)J
    ...
    invoke-virtual {p0, p1, v0, v1}, Lokio/i;->indexOfElement(Lokio/ByteString;J)J
...
.method public final rangeEquals(JLokio/ByteString;)Z
    ...
    invoke-virtual/range {v0 .. v5}, Lokio/i;->rangeEquals(JLokio/ByteString;II)Z
...
.method public final rangeEquals(JLokio/ByteString;II)Z
    ...
    invoke-virtual {p0, v5, v6}, Lokio/i;->request(J)Z
...
.method public final read([B)I
    ...
    invoke-virtual {p0, p1, v1, v0}, Lokio/i;->read([BII)I
...
.method public final read([BII)I
    ...
    iget-object p3, p0, Lokio/i;->a:Lokio/Buffer;
    ...
    invoke-virtual {p3, p1, p2, v1}, Lokio/Buffer;->read([BII)I
...
.method public final read(Lokio/Buffer;J)J
    ...
    iget-boolean v2, p0, Lokio/i;->c:Z

    if-nez v2, :cond_1

    iget-object v2, p0, Lokio/i;->a:Lokio/Buffer;
...
.method public final readAll(Lokio/Sink;)J
    ...
    :cond_0
    :goto_0
    iget-object v4, p0, Lokio/i;->b:Lokio/Source;

    const-wide/16 v5, 0x2000

    iget-object v7, p0, Lokio/i;->a:Lokio/Buffer;
    ...
    invoke-interface {p1, v7, v0, v1}, Lokio/Sink;->write(Lokio/Buffer;J)V
...
.method public final readByte()B
    ...
    invoke-virtual {p0, v0, v1}, Lokio/i;->require(J)V
...
.method public final readByteArray(J)[B
    ...
    invoke-virtual {p0, p1, p2}, Lokio/i;->require(J)V
...
.method public final readDecimalLong()J
    ...
    invoke-virtual {p0, v3, v4}, Lokio/i;->request(J)Z

    move-result v3

    iget-object v4, p0, Lokio/i;->a:Lokio/Buffer;
    ...
    :cond_4
    :goto_2
    invoke-virtual {v4}, Lokio/Buffer;->readDecimalLong()J
...
.method public final readFully(Lokio/Buffer;J)V
    ...
    :try_start_0
    invoke-virtual {p0, p2, p3}, Lokio/i;->require(J)V
    :try_end_0
...
.method public final readFully([B)V
    ...
    invoke-virtual {p0, v1, v2}, Lokio/i;->require(J)V
    :try_end_0
    .catch Ljava/io/EOFException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {v0, p1, v2, v4}, Lokio/Buffer;->read([BII)I
...
.method public final readHexadecimalUnsignedLong()J
    ...
    :cond_5
    :goto_2
    invoke-virtual {v4}, Lokio/Buffer;->readHexadecimalUnsignedLong()J
...
.method public final readUtf8Line()Ljava/lang/String;
    ...
    invoke-virtual {p0, v0}, Lokio/i;->indexOf(B)J
    ...
    invoke-virtual {p0, v0, v1}, Lokio/i;->readUtf8(J)Ljava/lang/String;
    ...
    :cond_1
    invoke-virtual {v4, v0, v1}, Lokio/Buffer;->e(J)Ljava/lang/String;
...
.method public final readUtf8LineStrict()Ljava/lang/String;
    ...
    invoke-virtual {p0, v0, v1}, Lokio/i;->readUtf8LineStrict(J)Ljava/lang/String;
...
.method public final readUtf8LineStrict(J)Ljava/lang/String;
    ...
    iget-object v4, v6, Lokio/i;->a:Lokio/Buffer;
    ...
    invoke-virtual {v6, v13, v14}, Lokio/i;->request(J)Z
    ...
    invoke-virtual {v6, v9, v10}, Lokio/i;->request(J)Z

    move-result v0

    if-eqz v0, :cond_2

    invoke-virtual {v4, v13, v14}, Lokio/Buffer;->getByte(J)B
    ...
    invoke-virtual {v4, v13, v14}, Lokio/Buffer;->e(J)Ljava/lang/String;
    ...
    invoke-static {v1, v7, v8}, La/a;->e(Ljava/lang/String;J)Ljava/lang/String;
...
.method public final require(J)V
    ...
    invoke-virtual {p0, p1, p2}, Lokio/i;->request(J)Z
...
.method public final select(Lokio/Options;)I
    ...
    invoke-virtual {v0, p1}, Lokio/Buffer;->f(Lokio/Options;)I
    ...
    :cond_1
    iget-object v3, p1, Lokio/Options;->a:[Lokio/ByteString;
