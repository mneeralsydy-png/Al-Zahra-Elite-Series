...
.method private static c(Landroid/content/Context;Landroid/widget/RemoteViews;Ljava/lang/Class;ILjava/lang/String;)V
    .locals 4
...
.method private static d(Landroid/content/Context;Landroid/widget/RemoteViews;I)V
    .locals 7
...
.method public static refreshBtn(Landroid/content/Context;Landroid/widget/RemoteViews;)V
    ...
    invoke-static {p0}, Lcom/whatsapp/yo/yo;->D(Landroid/content/Context;)V
    ...
    const-string v1, "ModWdgStatusColor"
...
.method public static setMOD(Landroid/content/Context;Landroid/widget/RemoteViews;Ljava/lang/Class;)V
    ...
    invoke-static {p0, p1, p2, v1, v2}, Lcom/whatsapp/yo/WidgetProvider;->c(Landroid/content/Context;Landroid/widget/RemoteViews;Ljava/lang/Class;ILjava/lang/String;)V

    const-string v1, "hs"

    invoke-static {p0, p1, p2, v0, v1}, Lcom/whatsapp/yo/WidgetProvider;->c(Landroid/content/Context;Landroid/widget/RemoteViews;Ljava/lang/Class;ILjava/lang/String;)V
...
.method public static updateYoWAWidget(Landroid/content/Context;)V
    ...
    const-class v1, Lcom/whatsapp/yo/WidgetProvider;
...
.method public onUpdate(Landroid/content/Context;Landroid/appwidget/AppWidgetManager;[I)V
    ...
    invoke-static/range {p1 .. p1}, Lcom/whatsapp/yo/yo;->D(Landroid/content/Context;)V

    invoke-static/range {p1 .. p1}, Lcom/whatsapp/yo/shp;->init(Landroid/content/Context;)V

    :cond_0
    const-string v4, "wdg_layout"
    ...
    const-string v6, "wdg_title"

    invoke-static {v6, v5}, Lcom/whatsapp/yo/yo;->getResID(Ljava/lang/String;Ljava/lang/String;)I

    move-result v6

    const-string v7, "wdg_status"

    invoke-static {v7, v5}, Lcom/whatsapp/yo/yo;->getResID(Ljava/lang/String;Ljava/lang/String;)I

    move-result v7

    const-string v8, "wdg_logo"

    invoke-static {v8, v5}, Lcom/whatsapp/yo/yo;->getResID(Ljava/lang/String;Ljava/lang/String;)I

    move-result v8

    const-string v9, "wdg_utils"

    invoke-static {v9, v5}, Lcom/whatsapp/yo/yo;->getResID(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-static {v1, v12}, Lcom/whatsapp/yo/WidgetProvider;->a(Landroid/appwidget/AppWidgetManager;I)I

    move-result v15

    invoke-direct {v13, v14, v15}, Landroid/widget/RemoteViews;-><init>(Ljava/lang/String;I)V

    const-string v14, "ModWdgBKColor"
    ...
    invoke-static {v14, v15}, Lcom/whatsapp/youbasha/others;->getColor(Ljava/lang/String;I)I

    move-result v14

    const-string v15, "setBackgroundColor"

    invoke-virtual {v13, v4, v15, v14}, Landroid/widget/RemoteViews;->setInt(ILjava/lang/String;I)V

    const-string v14, "ModWdgTitleColor"
    ...
    invoke-virtual {v13, v6, v14}, Landroid/widget/RemoteViews;->setTextColor(II)V

    const-string v14, "ModWdgStatusColor"

    invoke-static {v14, v15}, Lcom/whatsapp/youbasha/others;->getColor(Ljava/lang/String;I)I

    move-result v14

    invoke-virtual {v13, v7, v14}, Landroid/widget/RemoteViews;->setTextColor(II)V

    invoke-virtual {v13, v5, v14}, Landroid/widget/RemoteViews;->setTextColor(II)V

    invoke-static {}, Lcom/whatsapp/yo/dep;->getMyName()Ljava/lang/String;

    move-result-object v14

    invoke-virtual {v13, v6, v14}, Landroid/widget/RemoteViews;->setTextViewText(ILjava/lang/CharSequence;)V

    sget v14, Lcom/whatsapp/yo/WidgetProvider;->a:I
    :try_end_0
    ...
    :try_start_1
    invoke-static {v10}, Lcom/whatsapp/yo/yo;->getMyStatus(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v14

    invoke-virtual {v13, v7, v14}, Landroid/widget/RemoteViews;->setTextViewText(ILjava/lang/CharSequence;)V
    ...
    :cond_1
    const-string v14, "plurals0268"

    const-string v15, "plurals"

    invoke-static {v14, v15}, Lcom/whatsapp/yo/yo;->getResID(Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-virtual {v15, v14, v2, v9}, Landroid/content/res/Resources;->getQuantityString(II[Ljava/lang/Object;)Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v13, v7, v2}, Landroid/widget/RemoteViews;->setTextViewText(ILjava/lang/CharSequence;)V

    :goto_1
    invoke-virtual {v1, v12}, Landroid/appwidget/AppWidgetManager;->getAppWidgetOptions(I)Landroid/os/Bundle;
    ...
    invoke-virtual {v13, v6, v10}, Landroid/widget/RemoteViews;->setTextViewText(ILjava/lang/CharSequence;)V

    :cond_3
    invoke-static {v0, v13, v8}, Lcom/whatsapp/yo/WidgetProvider;->d(Landroid/content/Context;Landroid/widget/RemoteViews;I)V

    new-instance v2, Landroid/content/Intent;

    const-class v4, Lcom/whatsapp/profile/ui/ProfileInfoActivity;

    invoke-direct {v2, v0, v4}, Landroid/content/Intent;-><init>(Landroid/content/Context;Ljava/lang/Class;)V

    invoke-static {v2}, Lcom/whatsapp/yo/yo;->notifIn(Landroid/content/Intent;)Landroid/content/Intent;
    ...
    :goto_3
    invoke-static {v0, v12, v2, v15}, Landroid/app/PendingIntent;->getActivity(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;

    move-result-object v2

    invoke-virtual {v13, v6, v2}, Landroid/widget/RemoteViews;->setOnClickPendingIntent(ILandroid/app/PendingIntent;)V

    new-instance v2, Landroid/content/Intent;

    const-class v15, Lcom/whatsapp/youbasha/ui/YoSettings/AllSettings;

    invoke-direct {v2, v0, v15}, Landroid/content/Intent;-><init>(Landroid/content/Context;Ljava/lang/Class;)V

    const-string v15, "lockOnBack"
    ...
    invoke-static {v0, v12, v4, v2}, Landroid/app/PendingIntent;->getActivity(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;

    move-result-object v4

    invoke-virtual {v13, v8, v4}, Landroid/widget/RemoteViews;->setOnClickPendingIntent(ILandroid/app/PendingIntent;)V
    ...
    invoke-direct {v9, v0, v4}, Landroid/content/Intent;-><init>(Landroid/content/Context;Ljava/lang/Class;)V

    invoke-static {v0, v12, v9, v2}, Landroid/app/PendingIntent;->getActivity(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;

    move-result-object v2

    invoke-virtual {v13, v7, v2}, Landroid/widget/RemoteViews;->setOnClickPendingIntent(ILandroid/app/PendingIntent;)V

    invoke-static {v0, v13}, Lcom/whatsapp/yo/WidgetProvider;->refreshBtn(Landroid/content/Context;Landroid/widget/RemoteViews;)V

    invoke-static {v0, v13, v3}, Lcom/whatsapp/yo/WidgetProvider;->setMOD(Landroid/content/Context;Landroid/widget/RemoteViews;Ljava/lang/Class;)V

    new-instance v2, Landroid/content/ComponentName;

    invoke-direct {v2, v0, v3}, Landroid/content/ComponentName;-><init>(Landroid/content/Context;Ljava/lang/Class;)V

    invoke-virtual {v1, v2, v13}, Landroid/appwidget/AppWidgetManager;->updateAppWidget(Landroid/content/ComponentName;Landroid/widget/RemoteViews;)V

    sget v2, Lcom/whatsapp/yo/WidgetProvider;->a:I

    invoke-static {v2}, Lcom/whatsapp/yo/WidgetProvider;->b(I)V
    :try_end_1
