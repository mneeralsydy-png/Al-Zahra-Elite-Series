...
.method public create()Landroid/support/v8/renderscript/Type;
    ...
    iget-object v3, p0, Landroid/support/v8/renderscript/Type$Builder;->mElement:Landroid/support/v8/renderscript/Element;

    iput-object v3, v2, Landroid/support/v8/renderscript/Type;->mElement:Landroid/support/v8/renderscript/Element;

    iget v3, p0, Landroid/support/v8/renderscript/Type$Builder;->mDimX:I

    iput v3, v2, Landroid/support/v8/renderscript/Type;->mDimX:I

    iget v3, p0, Landroid/support/v8/renderscript/Type$Builder;->mDimY:I

    iput v3, v2, Landroid/support/v8/renderscript/Type;->mDimY:I

    iget v3, p0, Landroid/support/v8/renderscript/Type$Builder;->mDimZ:I

    iput v3, v2, Landroid/support/v8/renderscript/Type;->mDimZ:I

    iget-boolean v3, p0, Landroid/support/v8/renderscript/Type$Builder;->mDimMipmaps:Z

    iput-boolean v3, v2, Landroid/support/v8/renderscript/Type;->mDimMipmaps:Z

    iget-boolean v3, p0, Landroid/support/v8/renderscript/Type$Builder;->mDimFaces:Z

    iput-boolean v3, v2, Landroid/support/v8/renderscript/Type;->mDimFaces:Z

    iget v3, p0, Landroid/support/v8/renderscript/Type$Builder;->mYuv:I

    iput v3, v2, Landroid/support/v8/renderscript/Type;->mDimYuv:I
