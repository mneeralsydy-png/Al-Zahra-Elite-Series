.class public final Landroid/core/view/ViewKt;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "doOnNextLayout",
        "doOnPreDraw",
        "Landroid/core/view/OneShotPreDrawListener;",
        "drawToBitmap",
...
.method public static final doOnAttach(Landroid/view/View;Lkotlin/jvm/functions/Function1;)V
    ...
    :cond_0
    new-instance v1, Landroid/core/view/ViewKt$doOnAttach$1;

    invoke-direct {v1, p0, p1}, Landroid/core/view/ViewKt$doOnAttach$1;-><init>(Landroid/view/View;Lkotlin/jvm/functions/Function1;)V
...
.method public static final doOnDetach(Landroid/view/View;Lkotlin/jvm/functions/Function1;)V
    ...
    :cond_0
    new-instance v1, Landroid/core/view/ViewKt$doOnDetach$1;

    invoke-direct {v1, p0, p1}, Landroid/core/view/ViewKt$doOnDetach$1;-><init>(Landroid/view/View;Lkotlin/jvm/functions/Function1;)V
...
.method public static final doOnLayout(Landroid/view/View;Lkotlin/jvm/functions/Function1;)V
    ...
    invoke-static {p0}, Landroid/core/view/ViewCompat;->isLaidOut(Landroid/view/View;)Z
    ...
    new-instance v3, Landroid/core/view/ViewKt$doOnLayout$$inlined$doOnNextLayout$1;

    invoke-direct {v3, p1}, Landroid/core/view/ViewKt$doOnLayout$$inlined$doOnNextLayout$1;-><init>(Lkotlin/jvm/functions/Function1;)V
...
.method public static final doOnNextLayout(Landroid/view/View;Lkotlin/jvm/functions/Function1;)V
    ...
    new-instance v1, Landroid/core/view/ViewKt$doOnNextLayout$1;

    invoke-direct {v1, p1}, Landroid/core/view/ViewKt$doOnNextLayout$1;-><init>(Lkotlin/jvm/functions/Function1;)V
...
.method public static final doOnPreDraw(Landroid/view/View;Lkotlin/jvm/functions/Function1;)Landroid/core/view/OneShotPreDrawListener;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    new-instance v1, Landroid/core/view/ViewKt$doOnPreDraw$1;

    invoke-direct {v1, p0, p1}, Landroid/core/view/ViewKt$doOnPreDraw$1;-><init>(Landroid/view/View;Lkotlin/jvm/functions/Function1;)V

    check-cast v1, Ljava/lang/Runnable;

    invoke-static {p0, v1}, Landroid/core/view/OneShotPreDrawListener;->add(Landroid/view/View;Ljava/lang/Runnable;)Landroid/core/view/OneShotPreDrawListener;
...
.method public static synthetic drawToBitmap$default(Landroid/view/View;Landroid/graphics/Bitmap$Config;ILjava/lang/Object;)Landroid/graphics/Bitmap;
    ...
    :cond_0
    invoke-static {p0, p1}, Landroid/core/view/ViewKt;->drawToBitmap(Landroid/view/View;Landroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
...
.method public static final getAllViews(Landroid/view/View;)Lkotlin/sequences/Sequence;
    ...
    invoke-direct {v0, p0, v1}, Landroid/core/view/ViewKt$allViews$1;-><init>(Landroid/view/View;Lkotlin/coroutines/Continuation;)V
...
.method public static final getAncestors(Landroid/view/View;)Lkotlin/sequences/Sequence;
    ...
    sget-object v1, Landroid/core/view/ViewKt$ancestors$1;->INSTANCE:Landroid/core/view/ViewKt$ancestors$1;
...
.method public static final getMarginEnd(Landroid/view/View;)I
    ...
    invoke-static {v2}, Landroid/core/view/MarginLayoutParamsCompat;->getMarginEnd(Landroid/view/ViewGroup$MarginLayoutParams;)I
...
.method public static final getMarginStart(Landroid/view/View;)I
    ...
    invoke-static {v2}, Landroid/core/view/MarginLayoutParamsCompat;->getMarginStart(Landroid/view/ViewGroup$MarginLayoutParams;)I
...
.method public static final postDelayed(Landroid/view/View;JLkotlin/jvm/functions/Function0;)Ljava/lang/Runnable;
    ...
    new-instance v1, Landroid/core/view/ViewKt$postDelayed$runnable$1;

    invoke-direct {v1, p3}, Landroid/core/view/ViewKt$postDelayed$runnable$1;-><init>(Lkotlin/jvm/functions/Function0;)V
...
.method public static final postOnAnimationDelayed(Landroid/view/View;JLkotlin/jvm/functions/Function0;)Ljava/lang/Runnable;
    ...
    new-instance v1, Landroid/core/view/ViewKt$postOnAnimationDelayed$runnable$1;

    invoke-direct {v1, p3}, Landroid/core/view/ViewKt$postOnAnimationDelayed$runnable$1;-><init>(Lkotlin/jvm/functions/Function0;)V
