.class public Labu3arab/mas/split/service/Splitter;
...
.field private delegate:Labu3arab/mas/split/service/SplitterDelegate;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Labu3arab/mas/split/service/Splitter;->context:Landroid/content/Context;

    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Labu3arab/mas/split/service/SplitterDelegate;)V
    .locals 0
    ...
    iput-object p2, p0, Labu3arab/mas/split/service/Splitter;->delegate:Labu3arab/mas/split/service/SplitterDelegate;
...
.method public generatePath(Landroid/net/Uri;)Ljava/lang/String;
    ...
    iget-object v0, p0, Labu3arab/mas/split/service/Splitter;->context:Landroid/content/Context;

    invoke-direct {p0, p1, v0}, Labu3arab/mas/split/service/Splitter;->generateFromKitkat(Landroid/net/Uri;Landroid/content/Context;)Ljava/lang/String;
    ...
    :cond_0
    iget-object v1, p0, Labu3arab/mas/split/service/Splitter;->context:Landroid/content/Context;
...
.method public split(Ljava/lang/String;DZ)V
    ...
    invoke-virtual {v0}, Labu3arab/mas/split/service/DataStorage;->getSplitDuration()I
    ...
    invoke-virtual {v0}, Labu3arab/mas/split/service/DataStorage;->getSelectedVideoPath()Ljava/lang/String;
    ...
    :cond_1
    invoke-virtual {v0}, Labu3arab/mas/split/service/DataStorage;->getVideoPath()Landroid/net/Uri;

    move-result-object v0

    invoke-virtual {v8, v0}, Labu3arab/mas/split/service/Splitter;->generatePath(Landroid/net/Uri;)Ljava/lang/String;
    ...
    iget-object v0, v8, Labu3arab/mas/split/service/Splitter;->delegate:Labu3arab/mas/split/service/SplitterDelegate;

    if-eqz v0, :cond_2

    iget-object v0, v8, Labu3arab/mas/split/service/Splitter;->delegate:Labu3arab/mas/split/service/SplitterDelegate;

    invoke-interface {v0}, Labu3arab/mas/split/service/SplitterDelegate;->started()V
    ...
    :try_start_1
    invoke-virtual/range {v1 .. v7}, Labu3arab/mas/split/service/Splitter;->trim(IILjava/lang/String;ILandroid/media/MediaExtractor;Ljava/lang/String;)V
    :try_end_1
    ...
    invoke-interface {v0, v10, v9}, Labu3arab/mas/split/service/SplitterDelegate;->progress(ILjava/lang/String;)V
    ...
    invoke-interface {v0}, Labu3arab/mas/split/service/SplitterDelegate;->completed()V
...
.method public trim(Ljava/lang/String;Ljava/lang/String;II)V
    ...
    invoke-virtual {v1}, Labu3arab/mas/split/service/DataStorage;->getVideoPath()Landroid/net/Uri;

    move-result-object v1

    invoke-virtual {p0, v1}, Labu3arab/mas/split/service/Splitter;->generatePath(Landroid/net/Uri;)Ljava/lang/String;
    ...
    invoke-virtual/range {v2 .. v8}, Labu3arab/mas/split/service/Splitter;->trim(IILjava/lang/String;ILandroid/media/MediaExtractor;Ljava/lang/String;)V
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_1
    ...
    :goto_2
    iget-object v2, p0, Labu3arab/mas/split/service/Splitter;->delegate:Labu3arab/mas/split/service/SplitterDelegate;

    invoke-interface {v2}, Labu3arab/mas/split/service/SplitterDelegate;->completed()V
