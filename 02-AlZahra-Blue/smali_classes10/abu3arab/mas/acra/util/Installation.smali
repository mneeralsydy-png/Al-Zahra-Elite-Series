.class public Labu3arab/mas/acra/util/Installation;
...
.method public static declared-synchronized id(Landroid/content/Context;)Ljava/lang/String;
    ...
    const-class v3, Labu3arab/mas/acra/util/Installation;

    monitor-enter v3

    :try_start_0
    sget-object v2, Labu3arab/mas/acra/util/Installation;->sID:Ljava/lang/String;
    ...
    invoke-static {v1}, Labu3arab/mas/acra/util/Installation;->writeInstallationFile(Ljava/io/File;)V

    :cond_0
    invoke-static {v1}, Labu3arab/mas/acra/util/Installation;->readInstallationFile(Ljava/io/File;)Ljava/lang/String;

    move-result-object v2

    sput-object v2, Labu3arab/mas/acra/util/Installation;->sID:Ljava/lang/String;
    :try_end_1
