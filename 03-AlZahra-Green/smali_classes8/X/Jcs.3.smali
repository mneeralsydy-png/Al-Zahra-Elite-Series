...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0}, LX/Jcs;-><init>(Z)V
...
.method public constructor <init>(Z)V
    ...
    iput-boolean p1, p0, LX/Jcs;->A01:Z
...
.method public A00(Ljava/security/cert/X509Certificate;Ljava/util/List;LX/JVE;)Ljava/security/cert/CertPathBuilderResult;
    ...
    iget-boolean v0, p0, LX/Jcs;->A01:Z
    ...
    const/4 v1, 0x0
    :try_end_1
    .catch LX/IAe; {:try_start_1 .. :try_end_1} :catch_5
    ...
    .catch LX/IAe; {:try_start_2 .. :try_end_2} :catch_5
    ...
    .catch LX/IAe; {:try_start_3 .. :try_end_3} :catch_5
    ...
    .catch LX/IAe; {:try_start_4 .. :try_end_4} :catch_5
    ...
    goto/16 :goto_5
    :try_end_5
    .catch LX/IAe; {:try_start_5 .. :try_end_5} :catch_5
    ...
    :try_end_6
    .catch LX/IAe; {:try_start_6 .. :try_end_6} :catch_5
    ...
    .catch LX/IAe; {:try_start_7 .. :try_end_7} :catch_5
    ...
    move-result-object v1
    :try_end_8
    .catch LX/IAe; {:try_start_8 .. :try_end_8} :catch_5
    ...
    invoke-virtual {p0, v0, p2, p3}, LX/Jcs;->A00(Ljava/security/cert/X509Certificate;Ljava/util/List;LX/JVE;)Ljava/security/cert/CertPathBuilderResult;
    ...
    throw v0
    :try_end_a
    .catch LX/IAe; {:try_start_a .. :try_end_a} :catch_5
    ...
    goto :goto_4
    :try_end_b
    .catch LX/IAe; {:try_start_b .. :try_end_b} :catch_5
    ...
    throw v0
    :try_end_c
    .catch LX/IAe; {:try_start_c .. :try_end_c} :catch_5

    :catch_5
    move-exception v0

    iput-object v0, p0, LX/Jcs;->A00:Ljava/lang/Exception;
...
.method public engineBuild(Ljava/security/cert/CertPathParameters;)Ljava/security/cert/CertPathBuilderResult;
    ...
    invoke-virtual {p0, v0, v3, p1}, LX/Jcs;->A00(Ljava/security/cert/X509Certificate;Ljava/util/List;LX/JVE;)Ljava/security/cert/CertPathBuilderResult;
    ...
    iget-object v1, p0, LX/Jcs;->A00:Ljava/lang/Exception;
    ...
    iget-object v0, p0, LX/Jcs;->A00:Ljava/lang/Exception;
