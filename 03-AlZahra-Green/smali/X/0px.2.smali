...
.method public bridge synthetic A06(Ljava/lang/Object;)V
    ...
    invoke-virtual {v3, v0}, LX/CZp;->A0E(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {v0, v2, v1}, LX/4iR;-><init>(Lcom/whatsapp/infra/core/jid/UserJid;Z)V
    ...
    iget-object v0, p0, LX/0px;->A00:LX/4aq;

    if-eqz v0, :cond_1

    new-instance v1, LX/4hH;

    invoke-direct {v1, v4}, LX/4hH;-><init>(Ljava/util/List;)V

    iget-object v0, v0, LX/4aq;->A01:Lkotlin/jvm/functions/Function1;
...
.method public A07(LX/4v4;)Z
    ...
    iget-object v3, p0, LX/0px;->A00:LX/4aq;
    ...
    iget-object v0, v3, LX/4aq;->A00:Ljava/util/List;
