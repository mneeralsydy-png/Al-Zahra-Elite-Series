.class public Landroid/core/app/NotificationCompat;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/core/app/NotificationCompat$BubbleMetadata;,
        Landroid/core/app/NotificationCompat$CarExtender;,
        Landroid/core/app/NotificationCompat$WearableExtender;,
        Landroid/core/app/NotificationCompat$Extender;,
        Landroid/core/app/NotificationCompat$Action;,
        Landroid/core/app/NotificationCompat$DecoratedCustomViewStyle;,
        Landroid/core/app/NotificationCompat$InboxStyle;,
        Landroid/core/app/NotificationCompat$MessagingStyle;,
        Landroid/core/app/NotificationCompat$BigTextStyle;,
        Landroid/core/app/NotificationCompat$BigPictureStyle;,
        Landroid/core/app/NotificationCompat$Style;,
        Landroid/core/app/NotificationCompat$Builder;,
        Landroid/core/app/NotificationCompat$GroupAlertBehavior;,
        Landroid/core/app/NotificationCompat$BadgeIconType;,
        Landroid/core/app/NotificationCompat$NotificationVisibility;,
        Landroid/core/app/NotificationCompat$StreamType;
    }
.end annotation
...
.method public static getAction(Landroid/app/Notification;I)Landroid/core/app/NotificationCompat$Action;
    ...
    invoke-static {v0}, Landroid/core/app/NotificationCompat;->getActionCompatFromAction(Landroid/app/Notification$Action;)Landroid/core/app/NotificationCompat$Action;
    ...
    invoke-static {v3, v4, v5, v1}, Landroid/core/app/NotificationCompatJellybean;->readAction(ILjava/lang/CharSequence;Landroid/app/PendingIntent;Landroid/os/Bundle;)Landroid/core/app/NotificationCompat$Action;
    ...
    invoke-static {p0, p1}, Landroid/core/app/NotificationCompatJellybean;->getAction(Landroid/app/Notification;I)Landroid/core/app/NotificationCompat$Action;
...
.method static getActionCompatFromAction(Landroid/app/Notification$Action;)Landroid/core/app/NotificationCompat$Action;
    .locals 30
    ...
    new-array v4, v4, [Landroid/core/app/RemoteInput;
    ...
    new-instance v15, Landroid/core/app/RemoteInput;
    ...
    invoke-direct/range {v7 .. v14}, Landroid/core/app/RemoteInput;-><init>(Ljava/lang/String;Ljava/lang/CharSequence;[Ljava/lang/CharSequence;ZILandroid/os/Bundle;Ljava/util/Set;)V
    ...
    invoke-direct/range {v6 .. v16}, Landroid/core/app/NotificationCompat$Action;-><init>(ILjava/lang/CharSequence;Landroid/app/PendingIntent;Landroid/os/Bundle;[Landroid/core/app/RemoteInput;[Landroid/core/app/RemoteInput;ZIZZ)V
    ...
    invoke-static {v2}, Landroid/core/graphics/drawable/IconCompat;->createFromIconOrNullIfZeroResId(Landroid/graphics/drawable/Icon;)Landroid/core/graphics/drawable/IconCompat;
    ...
    invoke-direct/range {v17 .. v27}, Landroid/core/app/NotificationCompat$Action;-><init>(Landroid/core/graphics/drawable/IconCompat;Ljava/lang/CharSequence;Landroid/app/PendingIntent;Landroid/os/Bundle;[Landroid/core/app/RemoteInput;[Landroid/core/app/RemoteInput;ZIZZ)V
    ...
    invoke-direct/range {v17 .. v27}, Landroid/core/app/NotificationCompat$Action;-><init>(ILjava/lang/CharSequence;Landroid/app/PendingIntent;Landroid/os/Bundle;[Landroid/core/app/RemoteInput;[Landroid/core/app/RemoteInput;ZIZZ)V
...
.method public static getActionCount(Landroid/app/Notification;)I
    ...
    invoke-static {p0}, Landroid/core/app/NotificationCompatJellybean;->getActionCount(Landroid/app/Notification;)I
...
.method public static getBubbleMetadata(Landroid/app/Notification;)Landroid/core/app/NotificationCompat$BubbleMetadata;
    .locals 2
    ...
    invoke-static {v0}, Landroid/core/app/NotificationCompat$BubbleMetadata;->fromPlatform(Landroid/app/Notification$BubbleMetadata;)Landroid/core/app/NotificationCompat$BubbleMetadata;
...
.method public static getInvisibleActions(Landroid/app/Notification;)Ljava/util/List;
    ...
    invoke-static {v4}, Landroid/core/app/NotificationCompatJellybean;->getActionFromBundle(Landroid/os/Bundle;)Landroid/core/app/NotificationCompat$Action;
...
.method public static getLocusId(Landroid/app/Notification;)Landroid/core/content/LocusIdCompat;
    .locals 3
...
.method public static getPeople(Landroid/app/Notification;)Ljava/util/List;
    ...
    new-instance v5, Landroid/core/app/Person$Builder;

    invoke-direct {v5}, Landroid/core/app/Person$Builder;-><init>()V

    invoke-virtual {v5, v4}, Landroid/core/app/Person$Builder;->setUri(Ljava/lang/String;)Landroid/core/app/Person$Builder;

    move-result-object v5

    invoke-virtual {v5}, Landroid/core/app/Person$Builder;->build()Landroid/core/app/Person;
