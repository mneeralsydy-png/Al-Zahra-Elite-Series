.class public Landroid/core/graphics/PathParser$PathDataNode;
...
.annotation system Ldalvik/annotation/EnclosingClass;
    value = Landroid/core/graphics/PathParser;
.end annotation
...
.method constructor <init>(C[F)V
    ...
    iput-char p1, p0, Landroid/core/graphics/PathParser$PathDataNode;->mType:C

    iput-object p2, p0, Landroid/core/graphics/PathParser$PathDataNode;->mParams:[F

    return-void
.end method

.method constructor <init>(Landroid/core/graphics/PathParser$PathDataNode;)V
    .locals 3

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iget-char v0, p1, Landroid/core/graphics/PathParser$PathDataNode;->mType:C

    iput-char v0, p0, Landroid/core/graphics/PathParser$PathDataNode;->mType:C

    iget-object v0, p1, Landroid/core/graphics/PathParser$PathDataNode;->mParams:[F

    array-length v1, v0

    const/4 v2, 0x0

    invoke-static {v0, v2, v1}, Landroid/core/graphics/PathParser;->copyOfRange([FII)[F

    move-result-object v0

    iput-object v0, p0, Landroid/core/graphics/PathParser$PathDataNode;->mParams:[F
...
.method private static addCommand(Landroid/graphics/Path;[FCC[F)V
    ...
    invoke-static/range {v0 .. v9}, Landroid/core/graphics/PathParser$PathDataNode;->drawArc(Landroid/graphics/Path;FFFFFFFZZ)V
...
.method private static drawArc(Landroid/graphics/Path;FFFFFFFZZ)V
    ...
    invoke-static/range {v16 .. v34}, Landroid/core/graphics/PathParser$PathDataNode;->arcToBezier(Landroid/graphics/Path;DDDDDDDDD)V

    return-void
.end method

.method public static nodesToPath([Landroid/core/graphics/PathParser$PathDataNode;Landroid/graphics/Path;)V
    .locals 5
    ...
    iget-object v4, v4, Landroid/core/graphics/PathParser$PathDataNode;->mParams:[F

    invoke-static {p1, v0, v1, v3, v4}, Landroid/core/graphics/PathParser$PathDataNode;->addCommand(Landroid/graphics/Path;[FCC[F)V

    aget-object v3, p0, v2

    iget-char v1, v3, Landroid/core/graphics/PathParser$PathDataNode;->mType:C
...
# virtual methods
.method public interpolatePathDataNode(Landroid/core/graphics/PathParser$PathDataNode;Landroid/core/graphics/PathParser$PathDataNode;F)V
    .locals 4
    ...
    :goto_0
    iget-object v1, p1, Landroid/core/graphics/PathParser$PathDataNode;->mParams:[F

    array-length v2, v1

    if-ge v0, v2, :cond_0

    iget-object v2, p0, Landroid/core/graphics/PathParser$PathDataNode;->mParams:[F
    ...
    iget-object v3, p2, Landroid/core/graphics/PathParser$PathDataNode;->mParams:[F
