.class public final Landroid/core/view/inputmethod/InputConnectionCompat;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/core/view/inputmethod/InputConnectionCompat$OnCommitContentListener;
    }
.end annotation
...
.method public static commitContent(Landroid/view/inputmethod/InputConnection;Landroid/view/inputmethod/EditorInfo;Landroid/core/view/inputmethod/InputContentInfoCompat;ILandroid/os/Bundle;)Z
    .locals 8

    invoke-virtual {p2}, Landroid/core/view/inputmethod/InputContentInfoCompat;->getDescription()Landroid/content/ClipDescription;

    move-result-object v0

    const/4 v1, 0x0

    invoke-static {p1}, Landroid/core/view/inputmethod/EditorInfoCompat;->getContentMimeTypes(Landroid/view/inputmethod/EditorInfo;)[Ljava/lang/String;
    ...
    invoke-virtual {p2}, Landroid/core/view/inputmethod/InputContentInfoCompat;->unwrap()Ljava/lang/Object;
    ...
    :cond_3
    invoke-static {p1}, Landroid/core/view/inputmethod/EditorInfoCompat;->getProtocol(Landroid/view/inputmethod/EditorInfo;)I
    ...
    :goto_3
    invoke-virtual {p2}, Landroid/core/view/inputmethod/InputContentInfoCompat;->getContentUri()Landroid/net/Uri;
    ...
    :goto_5
    invoke-virtual {p2}, Landroid/core/view/inputmethod/InputContentInfoCompat;->getLinkUri()Landroid/net/Uri;
...
.method public static createWrapper(Landroid/view/inputmethod/InputConnection;Landroid/view/inputmethod/EditorInfo;Landroid/core/view/inputmethod/InputConnectionCompat$OnCommitContentListener;)Landroid/view/inputmethod/InputConnection;
    .locals 4
    ...
    new-instance v1, Landroid/core/view/inputmethod/InputConnectionCompat$1;

    invoke-direct {v1, p0, v2, v0}, Landroid/core/view/inputmethod/InputConnectionCompat$1;-><init>(Landroid/view/inputmethod/InputConnection;ZLandroid/core/view/inputmethod/InputConnectionCompat$OnCommitContentListener;)V
    ...
    new-instance v3, Landroid/core/view/inputmethod/InputConnectionCompat$2;

    invoke-direct {v3, p0, v2, v1}, Landroid/core/view/inputmethod/InputConnectionCompat$2;-><init>(Landroid/view/inputmethod/InputConnection;ZLandroid/core/view/inputmethod/InputConnectionCompat$OnCommitContentListener;)V
...
.method static handlePerformPrivateCommand(Ljava/lang/String;Landroid/os/Bundle;Landroid/core/view/inputmethod/InputConnectionCompat$OnCommitContentListener;)Z
    .locals 12
    ...
    new-instance v10, Landroid/core/view/inputmethod/InputContentInfoCompat;

    invoke-direct {v10, v5, v6, v7}, Landroid/core/view/inputmethod/InputContentInfoCompat;-><init>(Landroid/net/Uri;Landroid/content/ClipDescription;Landroid/net/Uri;)V

    invoke-interface {p2, v10, v8, v9}, Landroid/core/view/inputmethod/InputConnectionCompat$OnCommitContentListener;->onCommitContent(Landroid/core/view/inputmethod/InputContentInfoCompat;ILandroid/os/Bundle;)Z
