...
.method constructor <init>(Landroid/support/v8/renderscript/RenderScript;Ljava/lang/String;Ljava/util/List;Ljava/util/List;[Landroid/support/v8/renderscript/ScriptGroup$Future;)V
    ...
    invoke-virtual {v2, p1}, Landroid/support/v8/renderscript/ScriptGroup$Closure;->getID(Landroid/support/v8/renderscript/RenderScript;)J
    ...
    invoke-virtual {p0, v2, v3}, Landroid/support/v8/renderscript/ScriptGroup;->setID(J)V
...
.method public execute()V
    ...
    iget-object v5, v8, Landroid/support/v8/renderscript/ScriptGroup$ConnectLine;->mAllocation:Landroid/support/v8/renderscript/Allocation;

    :cond_6
    goto :goto_6

    :cond_7
    iget-object v7, p0, Landroid/support/v8/renderscript/ScriptGroup;->mInputs:[Landroid/support/v8/renderscript/ScriptGroup$IO;
    ...
    iget-object v8, v7, Landroid/support/v8/renderscript/ScriptGroup$ConnectLine;->mFrom:Landroid/support/v8/renderscript/Script$KernelID;

    if-ne v8, v4, :cond_a

    iget-object v6, v7, Landroid/support/v8/renderscript/ScriptGroup$ConnectLine;->mAllocation:Landroid/support/v8/renderscript/Allocation;
    ...
    iget-object v8, v10, Landroid/support/v8/renderscript/ScriptGroup$IO;->mAllocation:Landroid/support/v8/renderscript/Allocation;
    ...
    iget v6, v4, Landroid/support/v8/renderscript/Script$KernelID;->mSlot:I

    const/4 v7, 0x0

    invoke-virtual {v5, v6, v9, v8, v7}, Landroid/support/v8/renderscript/Script;->forEach(ILandroid/support/v8/renderscript/Allocation;Landroid/support/v8/renderscript/Allocation;Landroid/support/v8/renderscript/FieldPacker;)V
...
.method public varargs execute([Ljava/lang/Object;)[Ljava/lang/Object;
    ...
    const-string v3, "less than expected "
    ...
    const-string v3, "more than expected "
    ...
    invoke-virtual {v1, v2, v3}, Landroid/support/v8/renderscript/RenderScript;->nScriptGroup2Execute(J)V
    ...
    invoke-virtual {v5}, Landroid/support/v8/renderscript/ScriptGroup$Future;->getValue()Ljava/lang/Object;

    move-result-object v6

    instance-of v7, v6, Landroid/support/v8/renderscript/ScriptGroup$Input;

    if-eqz v7, :cond_5

    move-object v7, v6

    check-cast v7, Landroid/support/v8/renderscript/ScriptGroup$Input;

    invoke-virtual {v7}, Landroid/support/v8/renderscript/ScriptGroup$Input;->get()Ljava/lang/Object;
...
.method public setInput(Landroid/support/v8/renderscript/Script$KernelID;Landroid/support/v8/renderscript/Allocation;)V
    ...
    invoke-virtual {p1, v1}, Landroid/support/v8/renderscript/Script$KernelID;->getID(Landroid/support/v8/renderscript/RenderScript;)J

    move-result-wide v5

    iget-object v1, p0, Landroid/support/v8/renderscript/ScriptGroup;->mRS:Landroid/support/v8/renderscript/RenderScript;

    invoke-virtual {v1, p2}, Landroid/support/v8/renderscript/RenderScript;->safeID(Landroid/support/v8/renderscript/BaseObj;)J

    move-result-wide v7

    invoke-virtual/range {v2 .. v8}, Landroid/support/v8/renderscript/RenderScript;->nScriptGroupSetInput(JJJ)V
...
.method public setOutput(Landroid/support/v8/renderscript/Script$KernelID;Landroid/support/v8/renderscript/Allocation;)V
    ...
    invoke-virtual/range {v2 .. v8}, Landroid/support/v8/renderscript/RenderScript;->nScriptGroupSetOutput(JJJ)V
