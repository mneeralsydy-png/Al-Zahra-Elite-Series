.class final Lokhttp3/internal/platform/g;
...
.method constructor <init>(Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;Ljava/lang/reflect/Method;Ljava/lang/Class;Ljava/lang/Class;)V
    ...
    iput-object p1, p0, Lokhttp3/internal/platform/g;->c:Ljava/lang/reflect/Method;

    iput-object p2, p0, Lokhttp3/internal/platform/g;->d:Ljava/lang/reflect/Method;

    iput-object p3, p0, Lokhttp3/internal/platform/g;->e:Ljava/lang/reflect/Method;

    iput-object p4, p0, Lokhttp3/internal/platform/g;->f:Ljava/lang/Class;

    iput-object p5, p0, Lokhttp3/internal/platform/g;->g:Ljava/lang/Class;
...
.method public final afterHandshake(Ljavax/net/ssl/SSLSocket;)V
    ...
    :try_start_0
    iget-object v0, p0, Lokhttp3/internal/platform/g;->e:Ljava/lang/reflect/Method;
...
.method public final configureTlsExtensions(Ljavax/net/ssl/SSLSocket;Ljava/lang/String;Ljava/util/List;)V
    ...
    iget-object v2, p0, Lokhttp3/internal/platform/g;->f:Ljava/lang/Class;

    const/4 v3, 0x0

    aput-object v2, v1, v3

    iget-object v2, p0, Lokhttp3/internal/platform/g;->g:Ljava/lang/Class;

    const/4 v4, 0x1

    aput-object v2, v1, v4

    new-instance v2, Lokhttp3/internal/platform/f;

    invoke-direct {v2, p2}, Lokhttp3/internal/platform/f;-><init>(Ljava/util/List;)V
    ...
    iget-object p3, p0, Lokhttp3/internal/platform/g;->c:Ljava/lang/reflect/Method;
...
.method public final getSelectedProtocol(Ljavax/net/ssl/SSLSocket;)Ljava/lang/String;
    ...
    :try_start_0
    iget-object v0, p0, Lokhttp3/internal/platform/g;->d:Ljava/lang/reflect/Method;
    ...
    check-cast v0, Lokhttp3/internal/platform/f;

    iget-boolean v1, v0, Lokhttp3/internal/platform/f;->b:Z

    if-nez v1, :cond_0

    iget-object v2, v0, Lokhttp3/internal/platform/f;->c:Ljava/lang/String;
    ...
    :cond_1
    iget-object p1, v0, Lokhttp3/internal/platform/f;->c:Ljava/lang/String;
    :try_end_0
    .catch Ljava/lang/reflect/InvocationTargetException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Ljava/lang/IllegalAccessException; {:try_start_0 .. :try_end_0} :catch_0
