...
.method public intercept(Lokhttp3/Interceptor$Chain;)Lokhttp3/Response;
    ...
    invoke-interface {v0, v2}, Lokhttp3/internal/cache/InternalCache;->trackResponse(Lokhttp3/internal/cache/CacheStrategy;)V
    ...
    invoke-static {v4}, Lokhttp3/internal/cache/CacheInterceptor;->c(Lokhttp3/Response;)Lokhttp3/Response;
    ...
    invoke-virtual {v2, v8}, Lokhttp3/Headers;->name(I)Ljava/lang/String;

    move-result-object v9

    invoke-virtual {v2, v8}, Lokhttp3/Headers;->value(I)Ljava/lang/String;
    ...
    :cond_6
    invoke-static {v9}, Lokhttp3/internal/cache/CacheInterceptor;->a(Ljava/lang/String;)Z

    move-result v11

    if-nez v11, :cond_7

    invoke-static {v9}, Lokhttp3/internal/cache/CacheInterceptor;->b(Ljava/lang/String;)Z
    ...
    invoke-virtual {v11, v5, v9, v10}, Lokhttp3/internal/Internal;->addLenient(Lokhttp3/Headers$Builder;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v6}, Lokhttp3/internal/cache/CacheInterceptor;->a(Ljava/lang/String;)Z

    move-result v8

    if-nez v8, :cond_a

    invoke-static {v6}, Lokhttp3/internal/cache/CacheInterceptor;->b(Ljava/lang/String;)Z
    ...
    invoke-virtual {v8, v5, v6, v9}, Lokhttp3/internal/Internal;->addLenient(Lokhttp3/Headers$Builder;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1}, Lokhttp3/internal/cache/CacheInterceptor;->c(Lokhttp3/Response;)Lokhttp3/Response;
    ...
    invoke-interface {v0}, Lokhttp3/internal/cache/InternalCache;->trackConditionalCacheHit()V

    invoke-interface {v0, v4, v1}, Lokhttp3/internal/cache/InternalCache;->update(Lokhttp3/Response;Lokhttp3/Response;)V
    ...
    invoke-direct {v3, v2, v0, v1}, Lokhttp3/internal/cache/a;-><init>(Lokio/BufferedSource;Lokhttp3/internal/cache/CacheRequest;Lokio/BufferedSink;)V
    ...
    :try_start_1
    invoke-interface {v0, v3}, Lokhttp3/internal/cache/InternalCache;->remove(Lokhttp3/Request;)V
    :try_end_1
