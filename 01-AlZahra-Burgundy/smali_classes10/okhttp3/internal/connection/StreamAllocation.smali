...
.method public constructor <init>(Lokhttp3/ConnectionPool;Lokhttp3/Address;Lokhttp3/Call;Lokhttp3/EventListener;Ljava/lang/Object;)V
    ...
    invoke-virtual {v1, p1}, Lokhttp3/internal/Internal;->routeDatabase(Lokhttp3/ConnectionPool;)Lokhttp3/internal/connection/RouteDatabase;
    ...
    iput-object v0, p0, Lokhttp3/internal/connection/StreamAllocation;->e:Lokhttp3/internal/connection/RouteSelector;
...
.method private a(ZZZ)Ljava/net/Socket;
    ...
    :cond_3
    iget-object p1, p2, Lokhttp3/internal/connection/RealConnection;->allocations:Ljava/util/List;
    ...
    iget-object v1, p2, Lokhttp3/internal/connection/RealConnection;->allocations:Ljava/util/List;
...
.method private b(ZIIII)Lokhttp3/internal/connection/RealConnection;
    .locals 18
    ...
    iget-boolean v6, v0, Lokhttp3/internal/connection/RealConnection;->noNewStreams:Z

    if-eqz v6, :cond_0

    invoke-direct {v1, v3, v3, v4}, Lokhttp3/internal/connection/StreamAllocation;->a(ZZZ)Ljava/net/Socket;
    ...
    :goto_0
    iget-object v7, v1, Lokhttp3/internal/connection/StreamAllocation;->g:Lokhttp3/internal/connection/RealConnection;
    ...
    :goto_1
    iget-boolean v8, v1, Lokhttp3/internal/connection/StreamAllocation;->h:Z
    ...
    iget-object v6, v1, Lokhttp3/internal/connection/StreamAllocation;->call:Lokhttp3/Call;

    invoke-virtual {v2, v6, v0}, Lokhttp3/EventListener;->connectionReleased(Lokhttp3/Call;Lokhttp3/Connection;)V
    ...
    :goto_4
    iget-object v6, v1, Lokhttp3/internal/connection/StreamAllocation;->c:Lokhttp3/ConnectionPool;
    ...
    iput v3, v1, Lokhttp3/internal/connection/StreamAllocation;->f:I
    ...
    invoke-virtual {v1, v7, v3}, Lokhttp3/internal/connection/StreamAllocation;->acquire(Lokhttp3/internal/connection/RealConnection;Z)V
    ...
    invoke-virtual {v0, v2}, Lokhttp3/internal/Internal;->routeDatabase(Lokhttp3/ConnectionPool;)Lokhttp3/internal/connection/RouteDatabase;
    ...
    :try_start_2
    iput-boolean v4, v1, Lokhttp3/internal/connection/StreamAllocation;->h:Z
...
.method private c(IIIIZZ)Lokhttp3/internal/connection/RealConnection;
    ...
    invoke-direct/range {v0 .. v5}, Lokhttp3/internal/connection/StreamAllocation;->b(ZIIII)Lokhttp3/internal/connection/RealConnection;
