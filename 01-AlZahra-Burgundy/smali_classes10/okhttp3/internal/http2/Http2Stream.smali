...
.field private final h:Lokhttp3/internal/http2/q;

.field final i:Lokhttp3/internal/http2/p;

.field final j:Lokhttp3/internal/http2/r;

.field final k:Lokhttp3/internal/http2/r;
...
.method constructor <init>(ILokhttp3/internal/http2/Http2Connection;ZZLjava/util/List;)V
    ...
    invoke-direct {v0, p0}, Lokhttp3/internal/http2/r;-><init>(Lokhttp3/internal/http2/Http2Stream;)V

    iput-object v0, p0, Lokhttp3/internal/http2/Http2Stream;->j:Lokhttp3/internal/http2/r;

    new-instance v0, Lokhttp3/internal/http2/r;

    invoke-direct {v0, p0}, Lokhttp3/internal/http2/r;-><init>(Lokhttp3/internal/http2/Http2Stream;)V

    iput-object v0, p0, Lokhttp3/internal/http2/Http2Stream;->k:Lokhttp3/internal/http2/r;
    ...
    new-instance p1, Lokhttp3/internal/http2/q;
    ...
    invoke-direct {p1, p0, v0, v1}, Lokhttp3/internal/http2/q;-><init>(Lokhttp3/internal/http2/Http2Stream;J)V

    iput-object p1, p0, Lokhttp3/internal/http2/Http2Stream;->h:Lokhttp3/internal/http2/q;

    new-instance p2, Lokhttp3/internal/http2/p;

    invoke-direct {p2, p0}, Lokhttp3/internal/http2/p;-><init>(Lokhttp3/internal/http2/Http2Stream;)V

    iput-object p2, p0, Lokhttp3/internal/http2/Http2Stream;->i:Lokhttp3/internal/http2/p;

    iput-boolean p4, p1, Lokhttp3/internal/http2/q;->e:Z

    iput-boolean p3, p2, Lokhttp3/internal/http2/p;->c:Z
...
.method private c(Lokhttp3/internal/http2/ErrorCode;)Z
    .locals 2
    ...
    :cond_0
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Stream;->h:Lokhttp3/internal/http2/q;

    iget-boolean v0, v0, Lokhttp3/internal/http2/q;->e:Z

    if-eqz v0, :cond_1

    iget-object v0, p0, Lokhttp3/internal/http2/Http2Stream;->i:Lokhttp3/internal/http2/p;

    iget-boolean v0, v0, Lokhttp3/internal/http2/p;->c:Z
    ...
    invoke-virtual {p1, v0}, Lokhttp3/internal/http2/Http2Connection;->m(I)Lokhttp3/internal/http2/Http2Stream;
...
.method final a()V
    ...
    iget-boolean v1, v0, Lokhttp3/internal/http2/q;->e:Z

    if-nez v1, :cond_1

    iget-boolean v0, v0, Lokhttp3/internal/http2/q;->d:Z

    if-eqz v0, :cond_1

    iget-object v0, p0, Lokhttp3/internal/http2/Http2Stream;->i:Lokhttp3/internal/http2/p;

    iget-boolean v1, v0, Lokhttp3/internal/http2/p;->c:Z

    if-nez v1, :cond_0

    iget-boolean v0, v0, Lokhttp3/internal/http2/p;->b:Z
    ...
    invoke-virtual {v0, v1}, Lokhttp3/internal/http2/Http2Connection;->m(I)Lokhttp3/internal/http2/Http2Stream;
...
.method final b()V
    ...
    iget-boolean v1, v0, Lokhttp3/internal/http2/p;->b:Z
...
.method public close(Lokhttp3/internal/http2/ErrorCode;)V
    ...
    invoke-direct {p0, p1}, Lokhttp3/internal/http2/Http2Stream;->c(Lokhttp3/internal/http2/ErrorCode;)Z
    ...
    invoke-virtual {v0, v1, p1}, Lokhttp3/internal/http2/s;->j(ILokhttp3/internal/http2/ErrorCode;)V
...
.method public closeLater(Lokhttp3/internal/http2/ErrorCode;)V
    ...
    invoke-virtual {v0, v1, p1}, Lokhttp3/internal/http2/Http2Connection;->p(ILokhttp3/internal/http2/ErrorCode;)V

    return-void
.end method

.method final d(Lokio/BufferedSource;I)V
    .locals 3
    ...
    invoke-virtual {v0, p1, v1, v2}, Lokhttp3/internal/http2/q;->a(Lokio/BufferedSource;J)V
...
.method final e()V
    ...
    iput-boolean v1, v0, Lokhttp3/internal/http2/q;->e:Z
...
.method final f(Ljava/util/ArrayList;)V
    .locals 3
...
.method final declared-synchronized g(Lokhttp3/internal/http2/ErrorCode;)V
    .locals 1
...
.method public declared-synchronized isOpen()Z
    ...
    iget-boolean v2, v0, Lokhttp3/internal/http2/q;->e:Z
    ...
    iget-boolean v2, v0, Lokhttp3/internal/http2/p;->c:Z
...
.method public readTimeout()Lokio/Timeout;
    ...
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Stream;->j:Lokhttp3/internal/http2/r;
...
.method public sendResponseHeaders(Ljava/util/List;Z)V
    ...
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Stream;->i:Lokhttp3/internal/http2/p;

    iput-boolean v0, p2, Lokhttp3/internal/http2/p;->c:Z
    ...
    invoke-virtual {v0, v1, p1, v2}, Lokhttp3/internal/http2/s;->l(ILjava/util/List;Z)V
...
.method public declared-synchronized takeResponseHeaders()Ljava/util/List;
    ...
    invoke-virtual {p0}, Lokhttp3/internal/http2/Http2Stream;->h()V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    invoke-virtual {v0}, Lokhttp3/internal/http2/r;->d()V
    ...
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Stream;->j:Lokhttp3/internal/http2/r;

    invoke-virtual {v1}, Lokhttp3/internal/http2/r;->d()V
...
.method public writeTimeout()Lokio/Timeout;
    ...
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Stream;->k:Lokhttp3/internal/http2/r;
